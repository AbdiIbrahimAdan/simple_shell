...
/**
 * p_list_el - prints all elements of a list_t linked list
 * @h: pointer to first node
 *
 * Return: size of list
 */
...
/**
 * start_of_node - returns node whose string starts with prefix
...
/**
 * index_of_node - gets the index of a node
