## Simple Shell
> In this project, we created a simple Unix shell. A shell is an interactive
...
> Our shell is a simple version that handles memory leaks very well and has basic functionality.
...
Install and Compile
```
(your_terminal)$ git clone https://github.com/mwanikigachanja/simple_shell.git
